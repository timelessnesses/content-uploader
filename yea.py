...
def formatFileSize(size, sizeIn, sizeOut, precision=2):
    '''
...
total = formatFileSize(hdd.total,"B","GB")
used = formatFileSize(hdd.used,"B","GB")
free = formatFileSize(hdd.free,"B","GB")
